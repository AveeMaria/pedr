const words = {
    nouns: ["cornstar", "monarch", "OF creator", "bengali horse racer", "dedicated gambler", "tribal shaman", "retired prostitute", "cartel ","rare fish investor","mongolian seafearer","Austrian navy commander","V-tuber", "politician", "actor", "singer", "president", "serial killer", "hentai artist", "shaolin master", "rabbie", "minecraft streamer", "islamic extremist", "rebel", "terrorist", "violinist", "health expert"],
    names: ["Joe Biden", "Drake", "Donnald Trump", "Florida man","Quandale Dingle", "Elon Musk", "JoJo Siwa", "Mike Tyson", "Baby Gronk", "Kai Cenat", "Logan Paul", "Mr.Beast","Mark Zuck", "Livvy Dunne", "Putin", "Xi Jin Ping", "Christino Ronaldo", "Michael Obama", "Taylor Swift", "John Cena", "James Charles"],
    ...
    places: ["at a charity event", "at LSU college","during a Joe Rogan's podcast","in a viral video", "during a live broadcast", "during Thanksgiving dinner","at Oscars", "at a private party", "in a private mansion","on a private island","at a disclosed location", "during national landlord appreciation day", "during superbowl half-time"],
