const words = {
    ...
    activities: ["dance-battle", "singing contest", "rap battle","cheese rolling contest", "fishing olympics", "race walking","extreme ironing battle","russian roulete duel", "do nothing torunament", "boxing match", "a badminton tournament", "a tic tac toe duel", "chess tournament", "cooking competition", "a Fortnite duel", "a bowling duel"],
